namespace dbmid_project
{
    partial class View_Committees
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(View_Committees));
            label1 = new Label();
            ...
            // listView1
            // 
            listView1.Columns.AddRange(new ColumnHeader[] { cname, Event, Members, Action });
            listView1.ContextMenuStrip = contextMenuStrip1;
            listView1.Font = new Font("Segoe UI", 10.8F, FontStyle.Regular, GraphicsUnit.Point, 0);
            listView1.FullRowSelect = true;
            listView1.Items.AddRange(new ListViewItem[] { listViewItem1 });
            listView1.Location = new Point(48, 253);
            ...
            // Members
            // 
            Members.Text = "Number of Members";
            Members.TextAlign = HorizontalAlignment.Center;
            Members.Width = 250;
            // 
            // Action
            // 
            ...
            pictureBox1.Location = new Point(186, 125);
